...
public class VentanaAfiliadoAltaListaNegocios extends javax.swing.JFrame {

    public VentanaAfiliadoAltaListaNegocios() {
        initComponents();
        cargarTabla();
    }
    ...
    private void botonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAceptarActionPerformed
        ...
        if (filaRegistroSeleccionado == -1) {
            ...
            VentanaAfiliadosAlta.cargarCampoNegocio(nombreNegocioSeleccionado);
        }
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAfiliadoAltaListaNegocios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaAfiliadoAltaListaNegocios().setVisible(true);
            }
        });
    }
